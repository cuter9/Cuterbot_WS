...
SHUNT_RESISTOR_VALUE         = (0.005)   # default shunt resistor value of 0.1 Ohm
...
class SDL_Pi_INA3221():
    ...
    # INA3221 Code
    ###########################
    def __init__(self, twi=1, force=SLAVE_FORCE, addr=INA3221_ADDRESS, shunt_resistor = SHUNT_RESISTOR_VALUE  ):
        self._bus = smbus2.SMBus(twi, force)
        self._addr = addr
        self._force = force
