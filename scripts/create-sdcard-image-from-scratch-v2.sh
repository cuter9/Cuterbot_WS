...
# sudo -H python3 -m pip install -U testresources setuptools numpy==1.16.1 future==0.17.1 mock==3.0.5 h5py==2.9.0 keras_preprocessing==1.0.5 keras_applications==1.0.8 gast==0.2.2 futures==3.1.1 protobuf==3.3.0 pybind11
...
# TF>2 suport python3.8 an above
sudo rm -rf ~/tf_210
mkdir ~/tf_210
cd ~/tf_210
wget https://developer.download.nvidia.com/compute/redist/jp/v502/tensorflow/tensorflow-2.10.1+nv22.12-cp38-cp38-linux_aarch64.whl
sudo -H python3 -m pip install tensorflow-2.10.1+nv22.12-cp38-cp38-linux_aarch64.whl --force-reinstall
...
sudo -H python3 -m pip install torch-1.13.0a0+410ce96a.nv22.12-cp38-cp38-linux_aarch64.whl --force-reinstall
...
# Install bokeh
echo -e "\e[42m Install jupyter labe extension bokeh \e[0m"
