...
echo "Flassh comlplete. \
Plug the flashed sd card, mouse and display to jetson nano, and restart the the jetson nano.\
follow the instruction to finish the nano initilization."
